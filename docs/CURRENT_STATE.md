# Estado Atual — 2026-08-22 — v0.6.0

## Status: STAIRSLINK (PAR DE CÉLULAS LIGADAS) — JOGÁVEL E VALIDADO ✅
...
- **Escada = par de células ligadas** (`stairs`: [[base],[topo]]): ambas
  ...
  pareada (1 passo, sem ação especial); a transição dispara quando o
  caminho executa o salto — nunca automaticamente
...
- Nenhuma. BUG-011..015 resolvidos (ver BUG_MEMORY).
